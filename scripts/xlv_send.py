...
# 不同时段的风格
STYLE_PROMPTS = {
    "早间": "随机生成一条能引发讨论的日常生活内容。话题随机（食物对比、物品识别、价格猜测、生活选择、冷知识等），要有争议性没有标准答案，口语化像朋友发朋友圈。",
    "午间": "随机生成一条轻松搞笑的日常生活内容。话题随机（搞笑日常、反差对比、奇葩选择、神评论风格），要有趣味性能让人笑出来想转发，口语化像朋友发朋友圈。",
    "晚间": "随机生成一条有情感共鸣的日常生活内容。话题随机（人生选择、情感困惑、成长感悟、扎心真相），要有深度能引发思考，文案走心像深夜朋友圈。",
}
